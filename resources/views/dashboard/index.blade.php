        ...
        <div class="card bg-gradient-warning">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-md mb-0 text-white font-weight-bold">Auditor</p>
        ...
        <div class="card bg-gradient-success">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-md mb-0 text-white font-weight-bold">Fakultas</p>
                            <h5 class="font-weight-bolder text-white mb-0">
                                6
                    ...
                    <div class="col-4 text-end">
                        <div class="icon icon-shape text-white text-center ">
        ...
        <div class="card bg-gradient-dark">
            <div class="card-body p-3">
                <div class="row">
                    ...
                    <div class="col-4 text-end">
                        <div class="icon icon-shape text-center ">
                            <i class="ni ni-bullet-list-67 text-lg text-center opacity-10" aria-hidden="true"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
                ...
                <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                    ...
                    <p class="text-white text-sm">Pengawasan: Gunakan menu ini untuk mengetahui audit yang sedang
                        ...
                        dan statusnya.
                        .</p>
                    <p class="text-white text-sm">Untuk panduan menu lainya silahkan klik</p>
    ...
    <div class="col-lg-5 mb-lg-0 mb-4">
        <div class="card z-index-2">
            <div class="card-body p-3">
                ...
                <h6 class="ms-2 mt-4 mb-0"> User Login </h6>
                <p class="text-sm ms-2"> (<span class="font-weight-bolder">+23%</span>) bulan ini </p>
                    ...
                    <div class="row">
                        <div class="col-3 py-3 ps-0">
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-xs mt-1 mb-0 font-weight-bold">Fakultas</p>
                            </div>
                        ...
                        <div class="col-3 py-3 ps-0">
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-xs mt-1 mb-0 font-weight-bold">Prodi</p>
                            </div>
                        ...
                        <div class="col-3 py-3 ps-0">
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-xs mt-1 mb-0 font-weight-bold">Auditor</p>
                            </div>
...
<div class="row my-4">
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">SI - MIKOM</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">TI - MIKOM</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">MTK - MIKOM</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">ME - FE</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">BK - FAI</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">TK - FI</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
    ...
    <div class="col-lg-4 col-md-6">
        <div class="card h-100">
            <div class="card-header pb-0">
                <h6>Alur proses AMI</h6>
                <p class="text-sm">
                    <i class="fa fa-arrow-up text-success" aria-hidden="true"></i>
                    <span class="font-weight-bold">24%</span> Target bulan ini
                </p>
            </div>
            <div class="card-body p-3">
