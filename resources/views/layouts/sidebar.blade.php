        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" onclick="toggleSubmenu(event)">
                    ...
                    <span class="nav-link-text ms-1">Proses AMI &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i
                ...
                <ul class="submenu" style="display: none;">
                    <li class="nav-item"><a class="nav-link  " href="../pages/tables.html"><span
                                class="nav-link-text ms-3">Standar</span></a></li>
                    <li class="nav-item"><a class="nav-link  " href="../pages/tables.html"><span
                                class="nav-link-text ms-3">Periode</span></a></li>
                    <li class="nav-item"><a class="nav-link  " href="../pages/tables.html"><span
                                class="nav-link-text ms-3">Data AMI</span></a></li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" onclick="toggleSubmenu(event)">
                    ...
                    <span class="nav-link-text ms-1">Temuan
                ...
                <ul class="submenu" style="display: none;">
                    <li class="nav-item"><a class="nav-link  " href="../pages/tables.html"><span
                                class="nav-link-text ms-3">Mayor</span></a></li>
                    <li class="nav-item"><a class="nav-link  " href="../pages/tables.html"><span
                                class="nav-link-text ms-3">Minor</span></a></li>
                    <!-- <li class="nav-item"><a class="nav-link  " href="../pages/tables.html"><span
                                class="nav-link-text ms-3">submenu 3</span></a></li> -->
                </ul>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#" onclick="toggleSubmenu(event)">
                    ...
                    <span class="nav-link-text ms-1">Laporan
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-down"
                            aria-hidden="true"></i>
                    </span>
                </a>
                ...
                <ul class="submenu" style="display: none;">
                    <li class="nav-item"><a class="nav-link  " href="../pages/tables.html"><span
                                class="nav-link-text ms-3">Rekap Hasil</span></a></li>
                    <li class="nav-item"><a class="nav-link  " href="../pages/tables.html"><span
                                class="nav-link-text ms-3">Ranking Fakultas</span></a></li>
                    <li class="nav-item"><a class="nav-link  " href="../pages/tables.html"><span
                                class="nav-link-text ms-3">Ranking Prodi</span></a></li>
                </ul>
            </li>
        ...
        <div class="card card-background shadow-none card-background-mask-dark" id="sidenavCard">
            ...
            <div class="card-body text-start p-3 w-100">
                ...
                <div class="docs-info">
                    ...
                    <p class="text-xs font-weight-bold">Silahkan Kunjungi</p>
                    <a href="https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-dashboard"
                        target="_blank" class="btn btn-white btn-sm w-100 mb-0">Dokumentasi</a>
                </div>
            </div>
        </div>
