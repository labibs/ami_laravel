        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                <div class="input-group">
                    <!-- <h4>Audit Mutu Internal Periode Ke-3</h4> -->
                </div>
            </div>
            <ul class="navbar-nav  justify-content-end">
                <!-- <div class="col-lg-2 ms-auto text-center mt-1 mt-lg-0">
                            <div class="bg-gradient-dark border-radius-lg h-120">
                                <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                    <img class="w-10 position-relative z-index-2 pt-4"
                ...
                <li class="nav-item d-xl-none pe-3 mb-1 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-body p-0" id="iconNavbarSidenav">
                        <div class="sidenav-toggler-inner">
                            <i class="sidenav-toggler-line text-lg"></i>
                            <i class="sidenav-toggler-line text-lg"></i>
                            <i class="sidenav-toggler-line text-lg"></i>
                        </div>
                    </a>
                ...
                <li class="nav-item dropdown pe-2 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-body p-0" id="dropdownMenuButton"
                        ...
                        <i class="fa fa-bell text-lg cursor-pointer"></i>
                    </a>
