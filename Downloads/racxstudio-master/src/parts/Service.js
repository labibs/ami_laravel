  ...
  return (
    <div className="bg-gray-50">
      <div className="container mx-auto pt-20 pb-28">
        <Fade bottom>
          <h1 className="text-5xl text-theme-blue text-center font-bold">Prestasi Kami</h1>

          <p className="font-light text-lg text-gray-400 text-center mb-12">
          Dengan bangga, kami mempersembahkan prestasi-prestasi gemilang siswa-siswa kami.
          </p>
        </Fade>
