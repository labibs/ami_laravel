...
import BuildWebsite from 'assets/images/Siswa.png';
    ...
    <section className="hero">
      <Fade bottom>
        <div className="w-full lg:w-1/2 xl:pl-12 sm:pr-2 mt-8">
          <h3 className="text-5xl sm:text-6xl text-theme-blue font-bold leading-tight mb-5">
            Menuju madrasah
            {' '}
            <br />
            digital
          ...
          Madrasah Aliyah Negeri 2 Cilacap sebagai lembaga pendidikan dasar berciri khas Islam
          </p>
