...
export default function Portfolio({ data }) {
  return (
    <section className="container mx-auto flex flex-col items-center mt-20">
      <Fade bottom>
        <h1 className="text-5xl text-theme-blue text-center font-bold">Galeri</h1>

        <p className="font-light text-lg text-gray-400 text-center mb-12">
        Jelajahi galeri kami untuk melihat koleksi tentang kehidupan sekolah di sini.
        </p>
      </Fade>
      ...
      <Fade bottom>
        <Button href="/man2/project" type="link" className="flex flex-grow-0 w-36 h-12 sm:w-40 sm:h-14 lg:w-44 lg:h-16 xl:w-36 xl:h-12 text-theme-purple px-5 border border-theme-purple items-center mt-14 rounded-full justify-center transition duration-300 hover:bg-theme-purple hover:text-white">
